        ...
        <div class="form-wrapper min-vh-38">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <select v-model='metalType' class="form-control w-100" id="type_of_metal" name="type_of_metal">
                ...
                <div class="form-group col-md-6">
                    <label class="form-label" for="price">
                        Озвученная цена
                        <span class="text-warning font-weight-bolder" v-if="metalType == 1">(За тонну)</span>
                        <span class="text-warning font-weight-bolder" v-else>(За кг)</span>
                    </label>
                    <input type="number" step="any" pattern="\d*" id="price" name="price" class="form-control"
                           min="1" max="99999"  placeholder="Введите цену"
            ...
            <div class="row">
                <div class="form-group col-md-10">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="form-label" for="weight_from">
                                Вес от
                                <span class="text-warning font-weight-bolder">(В тоннах)</span>
                            </label>
                            <input type="number" step="any" id="weight_from" name="weight_from" class="form-control"
                                   placeholder="Введите вес" min="0" max="999"
                                   @if(!empty($query) && !empty($query->weight_from)) value="{{$query->weight_from}}" @endif/>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="form-label" for="weight_to">
                                Вес до
                                <span class="text-warning font-weight-bolder">(В тоннах)</span>
                            </label>
                            <input type="number" step="any" id="weight_to" name="weight_to" class="form-control"
                                   placeholder="Введите вес" min="0" max="999"
                                   @if(!empty($query) && !empty($query->weight_to)) value="{{$query->weight_to}}" @endif/>
                        </div>
                    </div>
                </div>
                <div class="form-group col-md-2">
                    <label class="form-label" for="scrap">Засор</label>
                    <input type="number" step="any" id="scrap" name="scrap" class="form-control" placeholder="Засор"
    ...
    <div id="address-step-vertical" class="content">
        <div class="form-wrapper min-vh-38">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <label class="form-label" for="custom_latitude">Широта</label>
                ...
                <div class="form-group col-md-6">
                    <label class="form-label" for="custom_longitude">Долгота</label>
...
@push('vue')
    <script>
        let driversVue = new Vue({
            el: "#metal-info-vertical",
            data: {
                metalType: {{$query->type_of_metal ?? '1'}},
            },
            methods: {
