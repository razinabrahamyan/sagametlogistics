...
<body class="vertical-layout vertical-menu-modern blank-page {{($configData['theme'] === 'dark') ? 'dark-layout' : 'light' }} {{ $configData['bodyClass'] }}data-layout="{{ ($configData['theme'] === 'light') ? '' : $configData['layoutTheme'] }}" style="{{ $configData['bodyStyle'] }}" data-framework="laravel" data-asset-path="{{ asset('/')}}">
