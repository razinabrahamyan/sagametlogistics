...
(function (window, document, $) {
  ...
  $(window).on('load', function () {
    ...
    if ($body.hasClass('menu-collapsed')) {
      compactMenu = true;
    } else if (localStorage.getItem('isMenuExpanded') === 'false') {
      compactMenu = true;
  ...
  $(document).on('click', '.menu-toggle, .modern-nav-toggle', function (e) {
    ...
    $.app.menu.toggle(); // Set Previous skin in local db

    localStorage.setItem('isMenuExpanded', $.app.menu.expanded);
    setTimeout(function () {
  ...
  $('.nav-link-style').on('click', function () {
    ...
    console.log(currentLayout); // If currentLayout is not dark layout

    if (currentLayout !== 'light-layout') {
      switchToLayout = 'light-layout';
    } else {
      // Switch to light
      switchToLayout = prevLayout ? prevLayout : 'dark-layout';
  ...
  function setLayout(currentLocalStorageLayout) {
    ...
    $html.removeClass('semi-dark-layout dark-layout light-layout bordered-layout');

    if (switchToLayout === 'light-layout') {
...
featherSVG = function featherSVG(iconSize) {
  if (feather) {
    // Feather Icons
